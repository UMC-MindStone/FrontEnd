...
class EmotionActionTimeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.timeConfirmTv.setOnClickListener {
            val selectedHour = binding.timeHourPicker.value
            val selectedMinute = binding.timeMinutePicker.displayedValues[binding.timeMinutePicker.value].toInt()
    ...
    private fun navigateToTime2() {
        val fragment = EmotionActionTimeFragment2()
    ...
    private fun setupMinutePicker() {
        ...
        binding.timeMinutePicker.apply {
            minValue = 0
